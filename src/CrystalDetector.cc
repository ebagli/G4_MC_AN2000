...
CrystalDetector::CrystalDetector(G4String name,const G4String& fileName,const G4String& fileName2):
G4VSensitiveDetector(name){
    ...
    G4String fileAtD2 = fileName2 + "_atd.txt";
    fNucleiDensity2 =   new G4ChannelingECHARM(fileAtD2,1.);
...
G4bool CrystalDetector::ProcessHits(G4Step*aStep,
    ...
    aHit->SetChPos(pos);
    aHit->SetNuD2(fNucleiDensity->GetEC(pos));
    aHit->SetNuD3(fNucleiDensity2->GetEC(pos));
