...
public:
    ...
    inline void SetNuD2(G4double z) { fNud2 = z; }
    inline G4double GetNuD2() const { return fNud2; }
    inline void SetNuD3(G4double z) { fNud3 = z; }
    inline G4double GetNuD3() const { return fNud3; }
    ...
    inline void SetKinE(G4double z) { fKinE = z; }
